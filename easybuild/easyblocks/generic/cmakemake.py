...
class CMakeMake(ConfigureMake):
    ...
    def configure_step(self, srcdir=None, builddir=None):
        ...
        if build_shared_libs is not None:
            # Contrary to other options build_shared_libs takes precedence over configopts.
            # This is to allow self.lib_ext to be determined correctly.
            # Notify users about this potentially unexpected behavior,
            # they can set `build_shared_libs = None` (default) in the EC to avoid this.
